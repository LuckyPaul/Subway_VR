...
public class ExampleManager : MonoBehaviour 
{
    ...
    void OnGUI()
    {
        ...
        GUI.Label(new Rect(150, 18, 600, 25), "xffect free version 2.0.0,limitation: only a few examples, no advance shaders and no event system");
        ...
        if (GUI.Button(new Rect(10, 100, 100, 20), "BombAffector"))
        {
            XBombAffector.Active();
        }
        ShowVolumetricLight1 = GUI.Toggle(new Rect(10, 120, 120, 20), ShowVolumetricLight1, "VolumetricLight1");
        GUI.EndScrollView();
    }
}
